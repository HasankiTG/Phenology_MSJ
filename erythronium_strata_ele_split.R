###Understory species - Erythronium
##Methodology:2.6.2.Identifying the time periods for which temperature best explains phenology
###DOY ~ T_temporal + (1| Site) + (1| Year)
